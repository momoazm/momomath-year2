  ...
  return (
    <div className="mx-auto w-full max-w-xl px-4 pb-28 pt-4">
      ...
      <div className="mb-5 flex items-center justify-between">
        <h1 className="font-display text-2xl font-extrabold text-slate-800">Item Shop</h1>
      ...
      <div className="mb-2 flex items-center justify-between">
        <h2 className="font-display text-sm font-bold uppercase tracking-wide text-slate-700">Spend 🌪️ Dust</h2>
      ...
      {/* Shop Items (gems) */}
      <h2 className="mb-2 font-display text-sm font-bold uppercase tracking-wide text-slate-700">Spend 💎 Gems</h2>
