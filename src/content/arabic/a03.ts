...
function a3AnthemHear(rand: Rand): Question {
  const line = pick(rand, [
    ...
    'أقول دائما شكرا',
    'أنا طفل لطيف',
    'أحافظ على نظافة مدرستي',
    'أحترم الكبير وأرحم الصغير',
    'أصدق في قولي وعملي',
    'أشارك أصدقائي لعبهم',
  ])
  const others = [
...
function a3AnthemSpeak(rand: Rand): Question {
  const line = pick(rand, [
    ...
    'أنا طفل لطيف أقول شكرا',
    'أحترم الكبير وأرحم الصغير',
    'أحافظ على نظافة مدرستي',
    'أصدق في قولي وأوفي بوعدي',
    'أحترم معلمي وأحب زملائي',
    'أنا طفل مهذب أحب وطني',
    'أساعد من حولي وأنا نشيط',
    'أحفظ كتابي ولا أضيع وقتي',
  ])
