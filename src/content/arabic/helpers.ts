...
/** Arabic picture bank: unambiguous, kid-friendly word → emoji pairings.
 *  Covers family, school, Nile, food, animals, home themes from Tawassol G2. */
export const PICTURE_BANK = {
  مدرسة: '🏫', بيت: '🏠', نيل: '🌊', سمكة: '🐟', مركب: '⛵',
  شمس: '☀️', قمر: '🌙', نجمة: '⭐', شجرة: '🌳', وردة: '🌸',
  قطة: '🐱', كلب: '🐶', عصفور: '🐦', حصان: '🐴', بقرة: '🐮',
  أسد: '🦁', فيل: '🐘', نحلة: '🐝', تفاحة: '🍎', موزة: '🍌',
  خبز: '🍞', جبنة: '🧀', كعكة: '🍰', لبن: '🥛', ماء: '💧',
  كرة: '⚽', كتاب: '📖', قلم: '✏️', كرسي: '🪑', باب: '🚪',
  سيارة: '🚗', قطار: '🚂', طائرة: '✈️', مطر: '🌧️', سحابة: '☁️',
  حديقة: '🏡', زهرة: '🌻', يد: '✋', عين: '👁️', أذن: '👂',
  معلم: '👨‍🏫', طبيب: '👨‍⚕️', فلاح: '👨‍🌾', جمل: '🐪', نخلة: '🌴',
} as const
...
/** Same generator contract as math/english/german: deterministic per (lessonId, seed),
