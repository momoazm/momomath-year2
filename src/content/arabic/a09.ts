...
const SHADDA_TANWEEN = ['قطٌّ', 'معلّمٌ', 'سيّارةً', 'تفّاحٌ', 'فتّاةٌ', 'شجّاعٌ', 'رجّالٌ', 'سجّادةٌ']
...
const SCHOOL_TF: Array<[string, boolean]> = [
  ...
  ['أرتب مكتبي وأحب مدرستي', true],
  ['أذاكر دروسي في وقتها', true],
  ['أقاطع زملائي ولا أكلمهم', false],
  ['أحترم معلمتي وأستمع لكلامها', true],
  ['أتأخر عن الحصة كل يوم', false],
]
