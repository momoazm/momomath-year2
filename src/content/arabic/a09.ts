...
const ISTIFHAM = [
  ...
  { tool: 'كيف', ex: 'كيف حالك اليوم؟' },
  { tool: 'أي', ex: 'أي كتاب تفضل؟' },
]
...
const QA_PAIRS = [
  ...
  { q: 'من يساعدك في دروسك؟', a: 'تساعدني أمي', others: ['يساعدني أخي', 'لا يساعدني أحد', 'يساعدني جدي'] },
  { q: 'ماذا تحب أن تلعب؟', a: 'أحب لعب الكرة', others: ['أحب القراءة', 'أحب النوم', 'أحب التلوين'] },
  { q: 'أين تقع مدرستك؟', a: 'في شارع المنزل', others: ['في السوق', 'في الحديقة', 'في المحطة'] },
  { q: 'كم ساعة تذاكر يوميا؟', a: 'ساعتان', others: ['ساعة واحدة', 'خمس ساعات', 'لا أذاكر'] },
]
...
const a9l1 = makeLesson(
  ...
  [a9ToolMatch, a9AnswerPick, a9PrepCloze, a9SchoolTF],
)
...
const PREP_MATCH = [
  ...
  { left: 'من', right: 'أخرج من البيت' },
  { left: 'مع', right: 'أذهب مع أبي' },
]
...
const PREP_CLOZE = [
  ...
  { s: 'أخرج .... البيت صباحا', ans: 'من', others: ['في', 'على'] },
  { s: 'أجلس .... الكرسي', ans: 'على', others: ['من', 'إلى'] },
  { s: 'أحمد .... مريم صديقان', ans: 'و', others: ['في', 'من'] },
  { s: 'ذاكرت دروسي .... لعبت', ans: 'ثم', others: ['في', 'على'] },
]
...
const a9l2 = makeLesson(
  ...
  [a9PrepMatch, a9PrepCloze, a9ShaddaTanween, a9SchoolOrder],
)
...
function a9SchoolOrder(rand: Rand): Question {
  const item = pick(rand, [
    ...
    ['أحب', 'معلمي', 'و', 'أصدقائي'],
    ['أذاكر', 'دروسي', 'في', 'المنزل'],
    ['ألعب', 'مع', 'أصدقائي', 'بعد', 'الدرس'],
  ])
