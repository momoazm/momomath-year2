...
const GOV_MATCH = [
  ...
  { left: 'الشارع', right: '🛣️ طريق نمشي فيه' },
  { left: 'المكتبة', right: '📚 نستعين بالكتب فيها' },
  { left: 'الحديقة', right: '🌳 ألعب وأتنفس هواءً نقيًا' },
]
...
const GOV_MCQ: { q: string; a: string; others: string[] }[] = [
  { q: 'أعيش في مكان فيه بيوت وشوارع كثيرة. هل هو مدينة أم قرية؟', a: 'مدينة', others: ['قرية'] },
  { q: 'في أي مكان تنمو الحقول والمحاصيل؟', a: 'القرية', others: ['المدينة', 'الحي', 'العاصمة'] },
  { q: 'ما الذي ينقسم إليه المدينة ويضم بيوت الجيران؟', a: 'الحي', others: ['المحافظة', 'القرية', 'المدينة'] },
  { q: 'أي مكان أكبر: المدينة أم القرية؟', a: 'المدينة', others: ['القرية', 'الحي', 'الشارع'] },
  { q: 'أين توجد المدرسة والمستشفى والسوق عادة؟', a: 'المدينة', others: ['القرية', 'الحقل', 'الصحراء'] },
  { q: 'الجزء الكبير من الدولة الذي يضم مدنًا وقريًا يسمى...؟', a: 'المحافظة', others: ['الحي', 'القرية', 'المدينة'] },
  { q: 'أي مكان تراه أكثر هدوءًا وأنسبًا للزراعة؟', a: 'القرية', others: ['المدينة', 'الحي', 'العاصمة'] },
  { q: 'العاصمة القاهرة أمثلة على...؟', a: 'مدينة', others: ['قرية', 'مزرعة', 'حقل'] },
  { q: 'أين يوجد المصنع والشركة الكبيرة عادة؟', a: 'المدينة', others: ['القرية', 'الحقل', 'الصحراء'] },
  { q: 'القرية والمدينة معا يسكنهما...؟', a: 'الناس', others: ['الطيور فقط', 'السياح فقط', 'الحيوانات فقط'] },
]

function d1GovPick(rand: Rand): Question {
  const item = pick(rand, GOV_MCQ)
  return mcqE(rand, item.q, item.a, item.others, {
...
const LOVE_LINES = [
  ...
  'أنا فخور بأنني مصري',
  'أحترم عائلتي وجيراني',
  'أزرع زهرة وأعتني بها',
  'أقول كلمات طيبة لأصدقائي',
  'أحني رأسي لنداء وطني بأمل',
]

function d1LoveSpeak(rand: Rand): Question {
  const line = pick(rand, LOVE_LINES)
  return speakQ('تحدث عن حبك لمصر', line, { hint: 'قل بفخر!' })
}

const PLACE_TILES = ['مصر', 'قاهرة', 'نيل', 'علم', 'جنيه', 'بلدي', 'أهرام', 'أسوان', 'حضارة', 'سلام']
