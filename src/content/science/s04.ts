...
const S4 = [gNaturalOrMade, gPropWord, gWhyThisMaterial, gSameMaterialSort, gChange, gHardVsSoft, gReversibleIdea, gOrderSolids, gMultiProp]

const lessons = [
  makeLesson('s4l1', 'Natural or Made?', ['2Cm.01'], 'cream', 'Found it or made it?', 'Wood comes from trees (natural) and plastic is made in a factory (manufactured).', [gNaturalOrMade, gNaturalOrMade], gNaturalOrMade),
  makeLesson('s4l2', 'Material Properties', ['2Cp.01'], 'tails', 'Hard, soft, shiny, dull!', 'Every material has properties — describing words that help us choose them for a job.', [gPropWord, gMultiProp], gPropWord),
  makeLesson('s4l3', 'Choosing the Right Material', ['2Cp.02'], 'shadow', 'Pick the perfect one!', 'Windows use glass because it is transparent. Pans use metal because it is strong and hard.', [gWhyThisMaterial, gPropWord], gWhyThisMaterial),
