...
const SHUAIB_MATCH = [
  ...
  { left: 'مدين', right: '🏙️ أرض النبي شعيب' },
  { left: 'قومه', right: '🚫 كذبوا نبيهم' },
]
...
const SHUAIB_TF: Array<[string, boolean]> = [
  ...
  ['كان شعيب نبيا من أنبياء الله', true],
  ['أرسل الله شعيبا إلى قومه في مدين', true],
  ['مدح شعيب قومه على الغش في الكيل', false],
  ['كذب قوم شعيب نبيهم', true],
  ['نجى الله شعيبا والمؤمنين معه', true],
  ['كان قوم شعيب يعبدون الأصنام', true],
  ['آمن بشعيب قومه جميعا', false],
  ['أحب شعيب قومه ودعاهم إلى الخير', true],
]
...
const MUSA_MATCH = [
  ...
  { left: 'السحرة', right: '🤹 سحروا ثم آمنوا' },
  { left: 'الصخرة', right: '⛰️ ضربها فنبعت الماء' },
  { left: 'المن', right: '🕊️ طعام بني إسرائيل' },
]
...
const PROPHETS_MATCH = [
  ...
  { left: 'يونس', right: '🐋 ابتلعه الحوت' },
  { left: 'آدم', right: '🌱 أول الناس' },
  { left: 'موسى', right: '🌊 شق الله له البحر' },
]
...
function r5ProphetPick(rand: Rand): Question {
  const item = pick(rand, [
    ...
    { q: 'من أول الناس خلقا؟', a: 'آدم', others: ['نوح', 'موسى', 'إبراهيم'] },
    { q: 'من ابتلعه الحوت ثم أنجاه الله؟', a: 'يونس', others: ['يوسف', 'نوح', 'شعيب'] },
    { q: 'من رأى أحد عشر كوكبا في المنام؟', a: 'يوسف', others: ['إبراهيم', 'موسى', 'نوح'] },
  ])
