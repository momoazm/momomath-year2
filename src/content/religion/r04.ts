...
const DAWA_MATCH = [
  ...
  { left: 'حمزة', right: '🏹 عم النبي' },
  { left: 'بلال', right: '📿 من أوائل المؤمنين' },
  { left: 'علي', right: '👦 أول من آمن من الصغار' },
]
...
const CHARACTER_TF: Array<[string, boolean]> = [
  ...
  ['كان النبي رحيما بالصغار', true],
  ['كذب النبي قبل البعثة', false],
  ['حفظ النبي الأمانة وردها لأصحابها', true],
  ['سخر النبي من الناس واستهزأ بهم', false],
  ['أنزل الله على النبي القرآن كمعجزة', true],
  ['كان النبي يرحم اليتيم ويحنو عليه', true],
]
...
function r4CharacterSpeak(rand: Rand): Question {
  const line = pick(rand, [
    ...
    'أحب النبي وأطيع أوامره',
    'نبينا محمد قدوتي في الخير',
    'أرسله الله رحمة للعالمين',
    'نتبع سنه ونحبه',
    'كان النبي يرحم اليتيم',
    'نبي الله محمد خير الخلق',
    'أحب النبي أكثر من كل شيء',
  ])
