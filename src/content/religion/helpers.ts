...
/** Religion picture bank: mosque, Quran, prayer, prophets' stories, values. */
export const PICTURE_BANK = {
  مسجد: '🕌', قرآن: '📖', صلاة: '🧎', دعاء: '🤲', مسبحة: '📿',
  كعبة: '🕋', هلال: '🌙', نجمة: '⭐', شمس: '☀️',
  وضوء: '💧', سجادة: '🧶', مئذنة: '🗼', مصحف: '📗',
  جمل: '🐪', سفينة: '🚢', نهر: '🌊', جبل: '⛰️', غار: '🕳️',
  نملة: '🐜', هدهد: '🐦', فيل: '🐘', نحلة: '🐝', عنكبوت: '🕷️',
  تفاحة: '🍎', تمر: '🌴', زيتون: '🫒', عسل: '🍯', لبن: '🥛',
  أب: '👨', أم: '👩', معلم: '👨‍🏫', طبيب: '👨‍⚕️', صديق: '🧑‍🤝‍🧑',
  مدرسة: '🏫', بيت: '🏠', حديقة: '🏡', كتاب: '📖', قلم: '✏️',
  صدقة: '💝', هدية: '🎁', نظافة: '🧼', ماء: '💧', شجرة: '🌳',
} as const
